  ...
  return (
    <div className="min-h-screen space-y-6 rounded-2xl bg-gradient-to-b from-slate-100 via-slate-50 to-blue-50/30 p-6 dark:from-slate-950 dark:via-slate-950 dark:to-slate-900">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-extrabold tracking-tight text-slate-900 dark:text-white">Cities</h1>
          <p className="mt-1 text-slate-600 dark:text-slate-200">Manage operational cities and regions</p>
        </div>
        <Button
        ...
        <CardContent>
          {isLoading ? (
            <div className="text-center py-8">
              <p className="text-slate-500 dark:text-slate-200">Loading cities...</p>
            </div>
          ) : error ? (
            ...
            <div className="text-center py-8">
              ...
              <p className="font-medium text-slate-600 dark:text-slate-100">No cities found</p>
              ...
              <table className="w-full text-sm">
                <thead className="border-b border-slate-200 dark:border-slate-600">
                  <tr>
                    ...
                    <th className="px-4 py-3 text-left font-bold text-slate-700 dark:text-white">State</th>
                ...
                <tbody className="divide-y divide-slate-200 dark:divide-slate-700">
                  {filteredCities.map((city: City) => (
                    <tr key={city.id} className="hover:bg-slate-100/70 dark:hover:bg-slate-800">
                      ...
                      <td className="px-4 py-3 font-semibold text-slate-900 dark:text-white">{city.name}</td>
