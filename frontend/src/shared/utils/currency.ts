...
import { formatConfiguredCurrency } from '../../config/currency';
 ...
 *
 * @example
 *   formatMoney(14950, beforeSymbolConfig) → "CUR 149.50"
 *   formatMoney(14950, afterSymbolConfig)  → "149.50 CUR"
 */
 ...
 * Falls back to the active runtime currency formatting.
 */
