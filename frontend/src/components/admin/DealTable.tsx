...
import { Pencil, Trash2, Plus, PackageSearch, PartyPopper } from 'lucide-react';
              ...
              {deals.map(deal => (
                <tr key={deal.id} className="hover:bg-muted/30 transition-colors">
                  <td className="px-4 py-2.5">
                    {deal.image ? (
                      ...
                      <div className="w-10 h-10 rounded-lg bg-muted flex items-center justify-center text-lg">
                        <PartyPopper className="h-5 w-5 text-muted-foreground/70" aria-hidden="true" />
                      </div>
                    )}
                  </td>
                  <td className="px-4 py-2.5">
                  ...
                  <td className="px-4 py-2.5 text-right hidden lg:table-cell">
                    <Badge variant="secondary" className="text-success-text font-semibold">
                  ...
                  <td className="px-4 py-2.5">
                    {confirmDeleteId === deal.id ? (
                      ...
                      <div className="flex items-center gap-1 justify-end">
                        <Button size="icon"
            aria-label="Edit" variant="ghost" className="h-7 w-7" onClick={() => openEdit(deal)}>
