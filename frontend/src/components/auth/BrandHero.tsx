    ...
    <div className="hidden lg:flex flex-col justify-center items-start lg:w-1/3 px-8 xl:px-16 py-8 select-none">
      ...
      <div className="flex items-center justify-start mb-8">
        <div className="relative">
          ...
          <div className="relative flex items-center justify-center w-20 h-20 bg-gradient-to-br from-orange-400 to-orange-600 rounded-2xl shadow-xl">
      ...
      <p className="text-2xl text-orange-300 font-bold tracking-wide mb-4">POS System</p>
      <p className="text-slate-300 text-lg">Fast. Professional. Reliable.</p>

      {/* Enterprise Description Footer */}
      <p className="text-slate-400 text-sm mt-8 max-w-sm leading-relaxed">
